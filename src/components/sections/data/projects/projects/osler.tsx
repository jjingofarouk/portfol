  ...
  content: (
    <div>
      ...
      <TypographyP className="font-mono">
        Osler Mentor is a Flask-based Progressive Web App (PWA) I developed to provide clinical medical guidance through a virtual Ugandan clinician, Dr. Osler. Powered by the Gemini API (`google-generativeai`), it delivers real-time, scenario-based medical responses in a responsive, offline-capable chat interface, showcasing my expertise in Python, Flask, and front-end development.
      </TypographyP>
