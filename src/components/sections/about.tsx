...
const INTERESTS = [
  ...
  },
  {
    ...
    icon: FaGlasses,
    gradient: "from-sapphire-600 to-violet-700",
  },
  {
    name: "Low-Code/No-Code",
    icon: FaCogs,
    gradient: "from-steel-600 to-gray-700",
  },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 relative z-10">
          ...
          >
            <div className="p-6 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-2xl transform-gpu">
              ...
              />
              <h2 className="text-2xl font-bold text-center text-zinc-100">
                Farouk Jjingo
              </h2>
          ...
          >
            <div className="p-8 rounded-2xl bg-zinc-900/70 border border-zinc-800 shadow-xl backdrop-blur-sm">
              ...
              <p className="text-zinc-300 mb-8 leading-relaxed text-lg">
                A Full Stack Engineer with roots in medicine, I fuse healthcare
                insights with cutting-edge tech. My creations blend clinical
                precision with sleek, futuristic design.
              </p>
