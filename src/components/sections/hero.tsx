            ...
            <>
              <div className="space-y-4">
                <BlurIn delay={0.5}>
                  <Badge
                    variant="outline"
                    className="px-4 py-1 text-sm font-normal bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm"
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link href="#projects" className="flex-1">
                    <BoxReveal delay={1.5} width="100%">
                      <Button
                        className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 flex items-center gap-2"
                      >
                        <Briefcase size={18} />
