...
{
  id: "marketminds-dashboard",
  category: "Finance",
  title: "MarketMinds",
  src: "/assets/projects-screenshots/marketminds/home.png",
  screenshots: [
    "home.png",
    "stock-detail.png",
    "ai-prediction.png",
  ...
  live: "https://marketminds-dashboard.vercel.app/",
  github: "https://github.com/jjingofarouk/marketminds-dashboard",
  skills: {
    frontend: [
      PROJECT_SKILLS.react,
      PROJECT_SKILLS.ts,
  ...
  get content() {
    return (
      <div>
        ...
        <SlideShow images={["/assets/projects-screenshots/marketminds/home.png"]} />
        ...
        <SlideShow images={["/assets/projects-screenshots/marketminds/stock-detail.png", "/assets/projects-screenshots/marketminds/ai-prediction.png"]} />
        ...
        <SlideShow images={["/assets/projects-screenshots/marketminds/portfolio.png"]} />
        <TypographyH3 className="my-4 mt-8">Real-time Financial News</TypographyH3>
        <p className="font-mono mb-2">
          MarketMinds integrates with free financial news APIs to surface real-time headlines and news sentiment analysis alongside stock data, giving users a complete view of the market landscape.
        </p>
        <SlideShow images={["/assets/projects-screenshots/marketminds/news.png"]} />
        ...
        <p className="font-mono mb-2 mt-5 text-center">
          MarketMinds showcases mastery in combining real-time systems, financial data handling, and ML prediction in a single, cohesive experience.
        </p>
      </div>
    );
  },
