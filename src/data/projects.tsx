...
},
{
  ...
  content: (
    <div>
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/search.png`, `${BASE_PATH}/favorites.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/cardiovascular.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/neurology.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/gastroenterology.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/nephrology.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/obstetrics.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/pulmonary.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/orthopedics.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/icu.png`]} />
      ...
      <SlideShow images={[`${BASE_PATH}/clinical-calculators/general.png`]} />
